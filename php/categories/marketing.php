            ...
            <div class="navbar">
                ...
                <div class="dropdown-content">
                    <a href="../categories/video.php">Video & Audio</a>
                        <a href="../workerregi/marketing.php">Marketing</a>
                        <a href="../categories/it.php">IT Developer</a>
                        <a href="../categories/caoching.php">Coaches</a>
                        <a href="../categories/coaching.php">Web Designer</a>
                </div>
                </div>
...
$query = "SELECT * FROM `marketingworker`";
